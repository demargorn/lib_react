...
class Reader extends Component {
   ...
   turnThePage(modificator) {
      const newCurrentPage = this.state.currentPage + modificator;
      const total = this.state.pages.length;

      this.setState({
         currentPage: newCurrentPage > 1 ? (newCurrentPage < total ? newCurrentPage : total) : 1,
      });
   }
}
